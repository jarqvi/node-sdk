 ...
 * no description
 */
export class DeployApiRequestFactory extends BaseAPIRequestFactory {
     ...
     */
    public async releasesDeploy(name: string, deployReleases: DeployReleases, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;

        // verify required parameter 'name' is not null or undefined
        if (name === null || name === undefined) {
            throw new RequiredError("DeployApi", "releasesDeploy", "name");
        }


        // verify required parameter 'deployReleases' is not null or undefined
        if (deployReleases === null || deployReleases === undefined) {
            throw new RequiredError("DeployApi", "releasesDeploy", "deployReleases");
        }


        // Path Params
        const localVarPath = '/v2/projects/{name}/releases'
        ...
        const serializedBody = ObjectSerializer.stringify(
            ObjectSerializer.serialize(deployReleases, "DeployReleases", ""),
            contentType
        );
     ...
     */
    public async sourcesDeploy(name: string, file: HttpFile, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;

        // verify required parameter 'name' is not null or undefined
        if (name === null || name === undefined) {
            throw new RequiredError("DeployApi", "sourcesDeploy", "name");
        }


        // verify required parameter 'file' is not null or undefined
        if (file === null || file === undefined) {
            throw new RequiredError("DeployApi", "sourcesDeploy", "file");
        }


        // Path Params
        const localVarPath = '/v2/projects/{name}/sources'
            .replace('{' + 'name' + '}', encodeURIComponent(String(name)));
...
export class DeployApiResponseProcessor {
