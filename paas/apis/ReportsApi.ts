...
export class ReportsApiRequestFactory extends BaseAPIRequestFactory {
     ...
     */
    public async getAppCpuReports(name: string, since: number, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;

        // verify required parameter 'name' is not null or undefined
        if (name === null || name === undefined) {
            throw new RequiredError("ReportsApi", "getAppCpuReports", "name");
        }


        // verify required parameter 'since' is not null or undefined
        if (since === null || since === undefined) {
            throw new RequiredError("ReportsApi", "getAppCpuReports", "since");
        }
     ...
     */
    public async getAppMemoryReports(name: string, since: number, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;

        // verify required parameter 'name' is not null or undefined
        if (name === null || name === undefined) {
            throw new RequiredError("ReportsApi", "getAppMemoryReports", "name");
        }


        // verify required parameter 'since' is not null or undefined
        if (since === null || since === undefined) {
            throw new RequiredError("ReportsApi", "getAppMemoryReports", "since");
        }
     ...
     */
    public async getAppNetworkReceiveReports(name: string, since: number, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;

        // verify required parameter 'name' is not null or undefined
        if (name === null || name === undefined) {
            throw new RequiredError("ReportsApi", "getAppNetworkReceiveReports", "name");
        }


        // verify required parameter 'since' is not null or undefined
        if (since === null || since === undefined) {
            throw new RequiredError("ReportsApi", "getAppNetworkReceiveReports", "since");
        }
     ...
     * @param name The name of your app
     */
    public async getAppSummaryReports(name: string, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;

        // verify required parameter 'name' is not null or undefined
        if (name === null || name === undefined) {
            throw new RequiredError("ReportsApi", "getAppSummaryReports", "name");
        }


        // Path Params
        const localVarPath = '/v1/projects/{name}/metrics/summary'
            .replace('{' + 'name' + '}', encodeURIComponent(String(name)));
     ...
     */
    public async getNetworkTransmitReports(name: string, since: number, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;

        // verify required parameter 'name' is not null or undefined
        if (name === null || name === undefined) {
            throw new RequiredError("ReportsApi", "getNetworkTransmitReports", "name");
        }


        // verify required parameter 'since' is not null or undefined
        if (since === null || since === undefined) {
            throw new RequiredError("ReportsApi", "getNetworkTransmitReports", "since");
        }
