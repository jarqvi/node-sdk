...
export class GetAppSummaryReports200ResponseCpuUsageInner {
    'value'?: Array<GetAppSummaryReports200ResponseCpuUsageInnerValueInner>;
    'applet'?: string;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        {
            "name": "value",
            "baseName": "value",
            "type": "Array<GetAppSummaryReports200ResponseCpuUsageInnerValueInner>",
            "format": ""
        },
        {
            "name": "applet",
    ...
    static getAttributeTypeMap() {
        return GetAppSummaryReports200ResponseCpuUsageInner.attributeTypeMap;
    }
