...
export class CreateAppDomain201Response {
    'domain'?: CreateAppDomain201ResponseDomain;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        {
            "name": "domain",
            "baseName": "domain",
            "type": "CreateAppDomain201ResponseDomain",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return CreateAppDomain201Response.attributeTypeMap;
    }
