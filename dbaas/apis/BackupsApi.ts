...
export class BackupsApiRequestFactory extends BaseAPIRequestFactory {
     ...
     * @param id 
     */
    public async createBackup(id: string, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;

        // verify required parameter 'id' is not null or undefined
        if (id === null || id === undefined) {
            throw new RequiredError("BackupsApi", "createBackup", "id");
        }


        // Path Params
        const localVarPath = '/v1/databases/{id}/backups'
     ...
     */
    public async downloadBackup(id: string, name: string, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;

        // verify required parameter 'id' is not null or undefined
        if (id === null || id === undefined) {
            throw new RequiredError("BackupsApi", "downloadBackup", "id");
        }


        // verify required parameter 'name' is not null or undefined
        if (name === null || name === undefined) {
            throw new RequiredError("BackupsApi", "downloadBackup", "name");
        }


        // Path Params
        const localVarPath = '/v1/databases/{id}/backups/{name}/download'
            .replace('{' + 'id' + '}', encodeURIComponent(String(id)))
     ...
     * @param id 
     */
    public async getListBackups(id: string, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;

        // verify required parameter 'id' is not null or undefined
        if (id === null || id === undefined) {
            throw new RequiredError("BackupsApi", "getListBackups", "id");
        }
